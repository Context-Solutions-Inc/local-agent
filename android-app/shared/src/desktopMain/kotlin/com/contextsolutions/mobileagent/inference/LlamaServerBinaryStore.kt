 ...
 *
 * `MOBILEAGENT_LLAMA_SERVER` overrides the binary path to an existing build (dev/testing;
 * skips download), and `MOBILEAGENT_LLAMA_SERVER_VARIANT` (`cpu`|`vulkan`|`auto`) overrides
...
class LlamaServerBinaryStore(
    ...
    private companion object {
        const val ENV_OVERRIDE = "MOBILEAGENT_LLAMA_SERVER"
