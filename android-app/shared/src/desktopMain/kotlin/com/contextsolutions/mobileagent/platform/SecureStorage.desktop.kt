 ...
 * derived from a stable per-user value (or the `MOBILEAGENT_KEYSTORE_PASSWORD`
...
class DesktopSecureStorage internal constructor(
    ...
    companion object {
        ...
        const val PASSWORD_ENV: String = "MOBILEAGENT_KEYSTORE_PASSWORD"
