...
class LlamaServerProcess(
    ...
    private companion object {
        const val ENV_EXTRA_ARGS = "LOCALAGENT_LLAMA_SERVER_ARGS"
 ...
 * device pin (#78) and the `LOCALAGENT_LLAMA_SERVER_ARGS` escape hatch — are unit-testable
...
internal fun buildServerArgs(
    ...
    // iGPU: LOCALAGENT_LLAMA_SERVER_ARGS="--cache-type-k q8_0 --cache-type-v q8_0".
