 ...
 *   [com.contextsolutions.localagent.search.vertical.DwmlParser] into the same
 *   entry shape as RSS, so [com.contextsolutions.localagent.agent.WeatherResponseFormatter]
 *   renders US weather deterministically (the way RSS handles Environment Canada).
 * - [HTML] — GET, run through [com.contextsolutions.localagent.search.vertical.HtmlReadabilityExtractor].
