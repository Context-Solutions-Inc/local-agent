...
sealed interface ParsedEvent {
    ...
    data class Done(val finishReason: com.contextsolutions.localagent.inference.FinishReason) : ParsedEvent
...
class MarkerFunctionCallParser(
    ...
    override fun parse(input: Flow<GenerationEvent>): Flow<ParsedEvent> = flow {
        ...
        when {
            ...
            else -> emit(ParsedEvent.Done(com.contextsolutions.localagent.inference.FinishReason.END_OF_TURN))
        }
    }
