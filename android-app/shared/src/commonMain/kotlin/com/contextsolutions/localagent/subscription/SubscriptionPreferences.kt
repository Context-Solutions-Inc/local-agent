 ...
 * ([com.contextsolutions.localagent.platform.SecureStorageKeys.RELAY_ACCOUNT_SECRET]),
 * never here.
 *
 * The seam is in commonMain so the shared Settings UI can render the desktop
 * "Local Agent Connection" section against [state]; the real implementation is
 * desktop-only ([com.contextsolutions.localagent.preferences.DesktopSubscriptionPreferences]).
