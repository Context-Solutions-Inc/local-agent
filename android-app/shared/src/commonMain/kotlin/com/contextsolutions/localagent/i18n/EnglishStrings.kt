...
object EnglishStrings {
    ...
    private val values: Map<String, StringValue> = mapOf(
        ...
        StringKeys.JOBS_CD_RESYNC to Simple("Re-sync jobs"),
        StringKeys.JOBS_RESYNC_TITLE to Simple("Re-sync jobs?"),
        StringKeys.JOBS_RESYNC_BODY to Simple("This clears the job list on this phone and re-pulls it from your desktop."),
        StringKeys.JOBS_RESYNC_CONFIRM to Simple("Re-sync"),
