 ...
 * `forceUnload`) on top of the raw [com.contextsolutions.localagent.classifier.LiteRtClassifierEngine].
 *
...
internal class ManagedClassifierEngine(
    ...
    /**
     * Reason-tagged variant used by [LocalAgentApplication.onTrimMemory] and
