...
object AndroidAuxModels {
    /** downloads.contextsolutions.com CDN base (`/models` path); shared with the desktop aux models + GGUF mirror. */
    const val BASE_URL: String = "https://downloads.contextsolutions.com/models"
